%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DownFilterTDT.m
%   Desc: Will downsample and/or filter TDT data
...
%
%       tdtDataPath:
%           String: Location of the saved mat-file of the TDT data. (from
%           TDT2mat())
%
%       dsFlag:
...
function [] = DownFilterTDT(override, tdtDataPath, dsFlag, dsFs, filtFlag, filtType, filtFs)
